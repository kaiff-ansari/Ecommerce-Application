...
import com.ecommerce.sb_ecom.service.UserDetailsServiceImpl;
...
public class WebSecurityConfig {
    ...
    public DaoAuthenticationProvider authenticationProvider(){
        ...
        authenicationProvider.setUserDetailsService(userDetailsService);
        authenicationProvider.setPasswordEncoder(passwordEncoder());
